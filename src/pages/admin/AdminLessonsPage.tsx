...
function buildColumns(
  ...
  return [
    ...
    },
    {
      ...
      label: "Module",
      render: (r: Record<string, any>) => (
        <span className="text-[#94a3b8]">{r.moduleTitle}</span>
      ),
    },
    {
      key: "type",
      label: "Type",
      render: (r: Record<string, any>) => (
        <span className="px-2 py-0.5 bg-[#6c63ff]/20 text-[#6c63ff] rounded text-xs">
          {r.type}
        </span>
      ),
    },
    ...
    <div className="p-6 space-y-5">
      ...
      <div>
        ...
        <p className="text-sm text-[#64748b] mt-1">
          Manage lesson content within modules
        </p>
      </div>
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="col-span-2">
            ...
            <select
              ...
              onChange={field("module_id")}
            >
              <option value="">Select a module…</option>
              {modules.map((m) => (
                <option key={m.id} value={m.id}>
                  {m.pathTitle ? `${m.pathTitle} → ` : ""}
                  {m.title}
                </option>
              ))}
            </select>
          ...
          <div>
            ...
            <input
              ...
              onChange={field("estimated_minutes")}
            />
          </div>
          <div>
